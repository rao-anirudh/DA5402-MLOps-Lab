...
# Relu function changed to be applied in all matrix items
...
# Cost function using sparse cross entropy loss
def cost(A3, Y):
    m = Y.shape[0]
...
def train(X, Y, input_size, hidden_layer1_size, hidden_layer2_size, output_size, learning_rate, epochs, batch_size,
          weights):
    # Inputs
    ...
    for epoch in range(epochs):
        ...
        # Perform the gradient descent in batches
